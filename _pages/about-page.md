...
I am a PhD student in Economics at the University of Copenhagen, enrolled in the department's 3+5 PhD program, with an expected completion in 2028. My research lies at the intersection of <span style="color: rgb(144, 26, 30);">market design</span>, <span style="color: rgb(144, 26, 30);">public economics</span>, and the <span style="color: rgb(144, 26, 30);">economics of education</span>. I study how families interact with complex allocation mechanisms and how institutional design and information environments shape access to public services and long-run opportunities.

One line of work examines <span style="color: rgb(144, 26, 30);">school choice</span> and the centralized assignment to upper-secondary education in Denmark. Together with collaborators and policy partners, I study how families navigate the hybrid Boston/DA admission mechanism, how misperceptions about admission chances and school quality arise, and how digital decision-support tools can lower information barriers. This work combines administrative data, survey evidence, and a large-scale field experiment that provides personalized guidance to families during the high-stakes school application process.

A second, solo-authored project develops a market-design framework for the provision and siting of <span style="color: rgb(144, 26, 30);">public amenities</span>. Using detailed usage data from Copenhagen's public library network, I estimate heterogeneous demand for different types of amenities and quantify how alternative network configurations—such as relocating, expanding, or redesigning branches—affect welfare and distributional outcomes across neighborhoods.
